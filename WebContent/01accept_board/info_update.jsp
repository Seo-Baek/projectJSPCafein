...
<body>
	...
	<div class="container" style="margin-bottom: 2%;">
		...
		<div class="row" align="center">
			...
			<form action="<%=request.getContextPath() %>/update_ok.do" method="post" id="frm">
				<input type="hidden" name="mno" value="${userNo }"/>
				<input type="hidden" name="mname" value="${userName }" />
				<input type="hidden" name="pwd" id="pwd" value="${dto.getBoard_pwd() }" />
